    ...
    <nav className='flex fixed z-20 bg-white top-0'>
      <div className='flex justify-around items-center w-screen'>
        ...
        <div className='hidden md:flex flex-row gap-7 hover:cursor-pointer'>
          ...
          <Link to='/profile' className='flex justify-center'><svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" className="bi bi-person md:w-[20px] lg:w-[23px]" viewBox="0 0 16 16">
